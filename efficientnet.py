...
def main(args):
    ...
    if 'findLSC' in args.comments and not 'lscvar' in args.comments:
        ...
        loss = lambda x, y: 0
        lsclr = str2val(args.comments, 'lsclr', float, default=1.e-3)
        adabelief = tfa.optimizers.AdaBelief(lr=lsclr, weight_decay=1.e-3)
