...
if __name__ == '__main__':
    ...
    for i, net_name in enumerate(nets):
        if net_name == 'pascal':
            ...
            path_1 = rf'D:\work\alif_sg\good_experiments\pmodels\pretrained_s0_{net_name}_radius_heidelberg_stack7.h5'
            path_05 = rf'D:\work\alif_sg\good_experiments\pmodels\pretrained_s0_{net_name}_radius_heidelberg_stack7_tn0p5.h5'
